/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0fd9ffdc233857ca52e27156fd6303e)
// Runtime types generated with workerd@1.20260507.1 2026-05-11 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchmakingSession";
	}
	interface Env {
		SESSION_KV: KVNamespace;
		CLOUDFLARE_TURN_SERVICE_ID: string;
		CLOUDFLARE_TURN_SERVICE_API_TOKEN: string;
		MATCHMAKING: DurableObjectNamespace<import("./src/index").MatchmakingSession>;
	}
}
